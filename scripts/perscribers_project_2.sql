...
-- CTE with 3 columns. One for each drug, and one for a summed total drug cost if it is a opioid and another if it is a antibiotic
...
-- Outputting the total cost for each drug type from the drug_cost CTE
SELECT
